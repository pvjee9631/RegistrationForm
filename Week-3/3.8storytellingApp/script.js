// html css codoo const-oor id bolon class-aar duudsan
...
// displayStory function zohioj hiine
function displayStory(genre) {

  if (storyObj.hasOwnProperty(genre)) {
    //  resultParagraph.textContent gedegn storyObj genre deer bicigdsen zuil bn 
    resultParagraph.textContent = storyObj[genre].story;
    storyContainer.style.borderColor = storyObj[genre].borderColor;
  }
}
// scaryStoryBtn deer darhad addEventListener ashiglaad "click" hiihed tuhain story garah function
